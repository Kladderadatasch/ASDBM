...
CREATE TABLE PFIELDS (FIELD_ID NUMBER NOT NULL, LOWX NUMBER(2) CHECK (LOWX>=0) NOT NULL, LOWY NUMBER(2) CHECK (LOWY>=0) NOT NULL, HIX NUMBER(2) CHECK (HIX<=50) NOT NULL, HIY NUMBER(2) CHECK (HIY<=50) NOT NULL, MAP NUMBER NOT NULL, GROUND_ID NUMBER(1) NOT NULL, PRIMARY KEY (FIELD_ID), FOREIGN KEY (GROUND_ID) REFERENCES GROUND(GROUND_ID));
...
CREATE TABLE SLOPES (SLOPE_ID NUMBER(1) NOT NULL, SCORE_INFL NUMBER(3,2) NOT NULL, VALUE NUMBER(3), PRIMARY KEY (SLOPE_ID));
