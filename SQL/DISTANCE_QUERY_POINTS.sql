SET LINESIZE 150
SET PAGESIZE 45
SELECT A.PATH_ID, P.POINT_ID AS "S_POINT", E.POINT_ID AS "E_POINT", P.S_X, P.S_Y, E.S_X AS "E_X", E.S_Y AS "E_Y", SDO_GEOM.SDO_LENGTH(SDO_GEOM.SDO_INTERSECTION(A.GEOM, C.GEOM, 0.005), M.DIMINFO)*D.SCORE_INFL AS "SCORE"
