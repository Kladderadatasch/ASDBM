CREATE TABLE GROUND (GROUND_ID NUMBER NOT NULL, NAME VARCHAR2(15) NOT NULL, SCORE_INFL NUMBER(3) NOT NULL, PRIMARY KEY (GROUND_ID));
...
CREATE TABLE STYPE (TYPE_ID NUMBER(1) NOT NULL, NAME VARCHAR2(15) NOT NULL, SCORE_INFL NUMBER(3) NOT NULL, PRIMARY KEY (TYPE_ID));

CREATE TABLE BOOTS (BOOT_ID NUMBER(1) NOT NULL, NAME VARCHAR2(20) NOT NULL, SCORE_INFL NUMBER(3) NOT NULL, PRIMARY KEY (BOOT_ID));

CREATE TABLE SCORE (SCORE_ID NUMBER(2) NOT NULL, PLAYER VARCHAR2(15) NOT NULL, SCORE NUMBER(5) NOT NULL, DISTANCE NUMBER(10) NOT NULL, BOOTS NUMBER(1) NOT NULL, PRIMARY KEY (SCORE_ID), FOREIGN KEY (BOOTS) REFERENCES BOOTS(BOOT_ID));
...
CREATE TABLE SLOPE (SLOPE_ID NUMBER NOT NULL, NAME VARCHAR2(20), SCORE_INFL NUMBER(3) NOT NULL, PRIMARY KEY (SLOPE_ID));
